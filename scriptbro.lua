...
local function initKeyVerification()
    local hasSaveSystem = pcall(function()
    ...
    if hasSaveSystem and coreGui:FindFirstChild("SourcesHubCore") and not lockFrame then 
        if not sourcesHubCore:FindFirstChild("Frame") then return end 
    end
